...
search() {
	...
	this.errors = {days : [],totals : []};
this.avgErrorType = {Moy : [],Type : []};
this.errorSolvingTime = {total : [],TimeU : []};
this.solvingTimeByCounterpart = {counterparts : [],count : [],percent : []};
this.solvingTimeByWire = {wires : [],count : [],percent : []};
this.solvingTimeByCPV = {connectors : [],count : [],percent : []};
    this.httpClient
      .get<any[]>('http://api.sunrise-pro.com/error/read.php?s='+this.line)
      .subscribe(
        (response :any) => {
